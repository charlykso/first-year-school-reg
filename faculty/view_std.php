...
<!-- <link rel="stylesheet" href="../ict/css/modal.css"> -->
<?php
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
									...
									<table class="table table-bordered " id="view_fee_table" >
										...
										<tbody>
											<?php
												...
												$sql = "SELECT * FROM fees WHERE reg_id = '$id'";
										...
										<div class="modal-content">
											...
											<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
															...
															echo "<td>".$row['description']."</td>
																	...
																	<td>";
															?>
																		<form action="post_accpt_std.php" method="post" enctype="multipart/form-data">
																			<input type='hidden' value="<?php echo $row['id']; ?>" name="fee_id">
																			<input type='hidden' value="<?php echo $row['reg_id']; ?>" name="reg_id">
																			<span class="fa fa-check"></span>
																			<input type="submit" name="submit_acpt" class="btn btn-success" value="Acpt" class="getData">
																		</form><br>
																		<form action="post_accpt_std.php" method="post" enctype="multipart/form-data">
																			<input type='hidden' value="<?php echo $row['id']; ?>" name="fee_id">
																			<input type='hidden' value="<?php echo $row['reg_id']; ?>" name="reg_id">
																			<span class="fa fa-trash-o"></span>
																			<input type="submit" name="submit_del" class="btn btn-danger" value="Delt" class="getData">
																		</form><br>
																		
																			<input type='hidden' value="<?php echo $row['id']; ?>" name="fee_id">
																			<input type='hidden' value="<?php echo $row['reg_id']; ?>" name="reg_id">
																			<span class="fa fa-envelope"></span>
																			<input type="button"  class="btn btn-info" value="Msg" data-toggle="modal" data-target="#dModal<?php echo $row['id']; ?>" class="getData">
						...
						<div class="modal-dialog">
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<form action="post_accpt_std.php" method="post" class="form">
